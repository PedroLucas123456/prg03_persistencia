...
public class CursoListar_1 extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(CursoListar_1.class.getName());
    ...
    private void btnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarActionPerformed
        ...
        CursoAdicionar_1 telaAdicionar = new CursoAdicionar_1(this, true, this.cursoController);
...
//                                                1. Pai  2. Modal  3. O CURSO       4. O CONTROLLER
            CursoEditar_1 telaEditar = new CursoEditar_1(this, true, cursoParaEditar, this.cursoController);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new CursoListar_1().setVisible(true));
    }
